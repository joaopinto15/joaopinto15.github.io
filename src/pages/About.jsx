...
function renderPoint(point) {
  ...
  point.replace(markdownLinkRegex, (match, linkText, linkHref, index) => {
    ...
    // Add the <a> tag for the link
    segments.push(<a href={linkHref} target="_blank" rel="noopener noreferrer"><strong>{linkText}</strong></a>);
  ...
  return (
    <section className='max-container'>
      ...
      <div className='py-10 flex flex-col'>
        <h3 className='subhead-text'>Used Technologies</h3>
